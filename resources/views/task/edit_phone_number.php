                ...
                <!-- Page-header start -->
                    <div class="page-header m-0 p-0">
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="d-inline ">
                                <h4 class="text-center mx-auto">Edit New Phone Number</h4>
                            </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                    ...
                    <div class="page-body">
                        ...
                        <form action="<?php echo route('phoner_number/update/' . $task->id); ?>" method="POST">
                            <div class="card">
                                <div class="row">
                                    <div class="col-xl-6 col-md-6 col-sm-6 col-xs-6" >
                                        <div class="card-block ">
                                            <h6 class="m-t-0">Edit New Phone Number</h6>
                                            <hr>
                                                ...
                                                <div class="col-md-8">
                                                    <select name="stock_group_id" class="form-control js-example-basic-single stock_group_id " required>
                                                        ...
                                                        <?php foreach ($stocks as $stock) { ?>
                                                            <option <?php if (!empty($task['stock_group_id'])) {
                                                                        echo validation($task['stock_group_id']) == $stock['id'] ? 'selected' : '';
                                                                    } ?> value="<?php echo $stock['id']; ?>"> <?php echo $stock['name']; ?>
                                                            </option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                            ...
                                            <div class="form-group my-2 my-2 my-1  row">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="radio" id="html" name="brand_id" <?php echo $task['brand'] == "Our Brand" ? 'checked' : ''; ?> value="Hamko">
                                                      <label for="html">HAMKO</label>
                                                      <input type="radio" class="ms-3" id="css" name="brand_id" <?php echo $task['brand'] == "Others Brand" ? 'checked' : ''; ?> value="Others Brand">
                                            ...
                                            <div class="form-group my-2 my-2 my-1  row">
                                                ...
                                                <div class="col-md-6 mt-2">
                                                        <input type="radio" id="html" name="phone_type" <?php echo $task['phone_type'] == "Owner" ? 'checked' : ''; ?> value="Owner">
                                                          <label for="html">Owner</label>
                                                          <input type="radio" class="ms-3" id="css" name="phone_type" <?php echo $task['phone_type'] == "User/Driver" ? 'checked' : ''; ?> value="User/Driver">
                                            ...
                                            <div class="form-group my-2 my-2 my-1 row">
                                                ...
                                                <div class="col-md-8">
                                                    ...
                                                    <input type="number" name="phone_number" id="phone_number" class="form-control CardNo duplicate_phone_number" value="<?php echo $task['phone_number']; ?>" placeholder="" required>
                                                </div>
                                            </div>
                                            <div class="form-group my-2 my-2 my-1 row">
                                                ...
                                                <div class="col-md-8">
                                                    ...
                                                    <input type="text" name="location" class="form-control CardNo " value="<?php echo $task['location']; ?>" placeholder="location" >
                                                </div>
                                            </div>
                                        </div>
                                     </div>
                                            ...
                                            <div class=" b-l-default m-t-0 " style="margin-left:-36px;">
                                                <div style="margin-left: 36px;">
                                                  <div class="form-group my-2 my-2 my-1 row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input type="text" name="customer_name" class="form-control" value="<?php echo $task['customer_name']; ?>" placeholder="Customer Name" >
                                                        </div>
                                                    </div>
                                                    <div class="form-group my-2 my-2 my-1 row">
                                                            <label class="col-md-3 col-form-label"> Date</label>
                                                            <div class="col-md-8">
                                                                <input type="date" name="date" class="form-control" value="<?php echo $task['phone_entry_date']; ?>" placeholder="" required>
                                                            </div>
                                                    </div>
                                                    <div class="form-group my-2 my-2 my-1 row">
                                                        <label class="col-md-3 col-form-label">Note</label>
                                                        <div class="col-md-8">
                                                            <input type="text" name="note" class="form-control DealerName" id='dealer' value="<?php echo $task['note']; ?>" placeholder="Type for Suggestion" >
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
<script>
    ...
    //             } else {
    //                 $("#user_name_span").removeClass("badge badge-success");
    //                 $("#user_name_span").text(' Phone ' + phone + " Already Exists").addClass("badge badge-danger");
    //                 $(":submit").attr("disabled", true);
    //             }
    //         }
    //     });
