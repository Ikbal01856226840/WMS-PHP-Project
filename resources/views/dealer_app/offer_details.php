        ...
        <div class="container">
            <div class="card">
                <div class="card-title card-img-top p-4">
                    <h3 class="text-white text-center"><?php echo $offer_details['offer_name'] ?></h3>
                </div>
                <div class="card-body">
                   <p><?php echo $offer_details['offer_message'] ?></p>
                    <?php if (!empty($offer_details['offer_file'])) { ?>
                      <?php if((substr($offer_details['offer_file'], -3)) == 'pdf') { ?>                      
                          <img src="<?php echo asset('libraries/pdf.png'); ?>" class="w-100 img-responsive" alt="..." />
                      <?php }else{ ?>                      
                          <img src="<?php echo asset($offer_details['offer_file']); ?>" class="w-100 img-responsive" alt="..." />
                      <?php } ?>
                      <div class="text-end mt-5">
                        <a class="btn btn-md btn-info" href="<?php echo asset($offer_details['offer_file']) ?>" download>download</a>
                      </div>
                    <?php } ?>
                </div>
            </div>
