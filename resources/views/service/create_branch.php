                ...
                <!-- Page-header start -->
                    <div class="page-header m-0 p-0">
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="d-inline ">
                                <h4 class="text-center mx-auto">Add Service Center</h4>
                            </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                    ...
                    <div class="page-body">
                        ...
                        <form action="<?php echo route('service/branch/save'); ?>" method="POST">
                            <div class="card">
                                <div class="row">
                                    <div class="col-xl-6 col-md-6 col-sm-6 col-xs-6" >
                                        <div class="card-block ">
                                            <h6 class="m-t-0">Service Center</h6>
                                            <hr>
                                            <div class="form-group my-2 row">
                                                <label class="col-md-3 col-form-label">Service Center Name</label>
                                                <div class="col-md-8">
                                                    <input type="text" name="service_center_name" class="form-control " placeholder="Enter Service Center Name" required>
                                                </div>
                                            </div>
                                            <div class="form-group my-2 row">
                                          ...
                                          <div class="form-group my-2 row">
                                                ...
                                                <div class="col-md-8">
                                                    <select name="Active" id="" class="form-control Active js-example-basic-single" required>
                                            ...
                                            <div class=" b-l-default m-t-0 " style="margin-left:-36px;">
                                                <div style="margin-left: 36px;">
                                                    ...
                                                    <div class="form-group my-2 row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input type="text" name="near_area" class="form-control thana" placeholder="" >
                                                        </div>
                                                    </div>
                                                    <div class="form-group my-2 row">
