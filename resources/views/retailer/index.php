                ...
                <div class="main-body">
                    <div class="page-wrapper">
                        ...
                        <div class="page-body">
                            ...
                            <form action="<?php echo route('retailer/index'); ?>" method="GET">
                                 <div class="row ">
                                        <div class="col-md-4">
                                            <label>Branch</label>
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h5 class="modal-title text-center" id="exampleModalLabel1"><b>Editting Retailer Information</b></h5>
            </div>
            <form action="">
                <div class="row">
                    <div class="col-md-12 text-right">
                        <div class="form-group my-2 row">
                            ...
                            <div class="col-md-8">
                                <select name="dealer_id" id="" class="form-control  dealer_id" required>
                                    <?php
                                    if (!empty($dealers)) {
                        ...
                        <div class="form-group my-2 row">
                            ...
                            <div class="col-md-8">
                                <select name="retailer_type" class="form-control retailer_type" id="" required>
                                    <?php
                                    if (!empty($dealertype)) {
                        ...
                        <div class="form-group my-2 row">
                            ...
                            <div class="col-md-8">
                                <input type="text" name="retailer_code" class="form-control retailer_code" value="<?php if (!empty($pid['dealercode'])) echo $pid['dealercode'] + 1; ?>" placeholder="" readonly>
                            </div>
                        </div>
                        <div class="form-group my-2 row">
                            <label class="col-md-3 col-form-label">Retailer Alias</label>
                            <div class="col-md-8">
                                <input type="text" name="retailer_alias" class="form-control retailer_alias" placeholder="">
                            </div>
                        </div>
                        <div class="form-group my-2 row">
                            <label class="col-md-3 col-form-label">Retailer Name</label>
                            <div class="col-md-8">
                                <input name="retailer_name" class="form-control retailer_name" placeholder="" required>
                            </div>
                        </div>
                        <div class="form-group my-2 row">
...
<script>
    $(document).ready(function() {
        $('.edit').click(function() {
            ...
            $.ajax({
                url: '<?php echo route('dealer/edit') ?>',
                type: 'POST',
                dataType: 'json',
                data: {
                    'id': id
                ...
                success: function(response) {
                    ...
                    $('.dealer_id').val(response.dealer[0].dealer_id);
                    $('.retailer_type').val(response.dealer[0].dealertype_id);
                    $('.ParentDealer').val(response.dealer[0].parent_dealer);
                    $('.retailer_code').val(response.dealer[0].dealercode);
                    $('.retailer_alias').val(response.dealer[0].dealeralise);
                    $('.retailer_name').val(response.dealer[0].name);
                    $('.retailer_Details').val(response.dealer[0].dealerdetails);
            ...
            $('.dealerupdate').click(function(event) {
                ...
                let retailer_type = $('.retailer_type').val();
                let parentdealer = $('.ParentDealer').val();
                let retailer_code = $('.retailer_code').val();
                let retailer_alias = $('.retailer_alias').val();
                let retailer_name = $('.retailer_name').val();
                ...
                let fax = $('.Fax').val();
                $.ajax({
                    url: "<?php echo route('retailer/save'); ?>",
                    dataType: "JSON",
                    method: "POST",
                    data: {
                        'id': id,
