                                ...
                                <div class="card">
                                    ...
                                    <div class="card-block">
                                            ...
                                            <div class="card-block " style="padding-bottom:0px ;">
                                                <h4><?php echo date('d F, Y', strtotime($individual_offer['start_date'])) ?></h4>
                                                    ...
                                                    foreach ($individual_offer_files as $key=>$individual_offer_file) { ?>
                                                     ...
                                                     if($pdf=='pdf'){?>
                                                        <?php if($c%2==0) {?>
                                                                <div class="col-xl-12 col-md-12 col-sm-12 col-xs-12 col-s-4" style="padding: 1px 8px;" >
                                        ...
                                        <div class="col-md-12 text-center">
                                            <a href="<?php echo route('offer/retrailer/index'); ?>" class="edit"><i class="btn btn-primary px-5 m-4  ">Black </i></a>
                                        </div>
                                    </div>
                                </div>
