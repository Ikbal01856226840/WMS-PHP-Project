                                    ...
                                    <div class="col-md-12">
                                        <div class="card">
                                            <div class=" card-header">
                                                <h4 class="card-title text-center"> Dealer Wise Warranty Search</h4>
                                            </div>
                                            <div class="card-body ">
                                                <div class="row">
        ...
        $('.DealerSearch').click(function() {
            ...
            if (dealer_id && FromDate && ToDate) {
                ...
                $('#dealersearch').DataTable({
                    "destroy": true,
                    ajax:{
                        url: "<?php echo route('warrantyCard/warrenty_search_dealer'); ?>",
                        type: 'POST',
                        data: {
                            // 'user_id': user_id,
                            'branch_id': branch_id,
                        ...
                        "columns": [
                            ...
                            { 
                                ...
                                "data": 'id',
                                "render":(data)=> `<button type="button" class="btn btn-primary edit btn-sm" name="edit" value="${data}">Edit</button>`
                                
                            },    
                            { 
                                className: ()=>(user_level==8)? 'd-none':'',
                                "data": 'id',
                                "render":(data)=>(user_level==8)?'':`<button type="button" class="btn btn-danger delete btn-sm" name="delete" value="${data}">Delete</button>`
                            }                    
                        ],
                    "searching": true,
